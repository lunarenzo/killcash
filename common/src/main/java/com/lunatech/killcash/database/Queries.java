...
import com.lunatech.killcash.cooldown.CooldownType;
import com.lunatech.killcash.cooldown.Cooldowns;
import com.lunatech.killcash.database.handler.DatabaseType;
import com.lunatech.killcash.database.schema.tables.records.CooldownsRecord;
import com.lunatech.killcash.messaging.message.BidirectionalMessage;
...
import static com.lunatech.killcash.database.QueryUtils.UUIDUtil;
import static com.lunatech.killcash.database.schema.Tables.*;
...
public final class Queries {
    ...
    /**
     * KillCash insert with returning key.
     * <p>
    ...
    /**
     * KillCash save all data to database.
     * <p>
    ...
    /**
     * KillCash load all data from database.
     * <p>
